...
it('cancels a pending transaction from a signed request and redirects', function (): void {
    ...
    $this->get(URL::signedRoute('sisp.cancel', [
        ...
        ->assertRedirectToSignedRoute('sisp.callback', ['ref' => 'MR-C'], absolute: false);
...
it('cancels a pending transaction resolved by transaction_id from a signed request', function (): void {
    ...
    $this->get(URL::signedRoute('sisp.cancel', [
        ...
        ->assertRedirectToSignedRoute('sisp.callback', ['ref' => 'MR-C3'], absolute: false);
...
it('cancels the invoice when cancelling from the signed route', function (): void {
    ...
    $this->get(URL::signedRoute('sisp.cancel', ['merchantRef' => 'MR-SIGNED-INV']))
        ->assertRedirectToSignedRoute('sisp.callback', ['ref' => 'MR-SIGNED-INV'], absolute: false);
