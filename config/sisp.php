...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Applications may send a stable key for the same checkout intent. The
    | package reserves that key before creating a SISP transaction, preventing
    | duplicate transactions while keeping merchant references and sessions
    | generated by the configured generators.
    |
    */
    'idempotency' => [
    ...
    */
    'identifier_generation' => [
        ...
        'collision_retry_sleep_microseconds' => env('SISP_IDENTIFIER_COLLISION_RETRY_SLEEP_MICROSECONDS', 1_000_000),
    ],
