    ...
    return (
      <div className='flex min-h-screen items-center justify-center bg-gray-50'>
          <div className='w-full max-w-md rounded-lg bg-white p-8 shadow-lg'>
                    ...
                    <div className='space-y-2 text-center'>
                        <div className='flex justify-center'>
                            <div className='rounded-full bg-yellow-100 p-4'>
                                <svg className='h-8 w-8 text-yellow-600 animate-spin'
                                     fill='none'
                                     stroke='currentColor'
                                     viewBox='0 0 24 24'>
              ...
              <div className='mt-8'>
                  <a href='/'
                     className='block w-full rounded-lg bg-blue-600 px-4 py-2 text-center font-medium text-white hover:bg-blue-700 transition'>
                      Voltar ao Início
                  </a>
              </div>
          </div>
