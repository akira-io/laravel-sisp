...
final class StorePaymentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'customer_vat' => ['sometimes', 'nullable', 'string', 'max:20'],
            'customer_tax_name' => ['sometimes', 'nullable', 'string', 'max:255'],
            'customer_tax_entity_type' => ['sometimes', 'nullable', 'string', 'max:20'],
            'customer_tax_address' => ['sometimes', 'nullable', 'string', 'max:255'],
